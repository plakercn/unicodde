 ...
 * @author rhaag
 */
class ImportStep00_en extends BasicStep {
	...
	public ImportStep00_en(UserRequest ureq, boolean canCreateOLATPassword) {
		super(ureq);
	...
	private final class ImportStepForm00 extends StepFormBasicController {
		...
		//非中文用户
		protected boolean validateFormLogicNOCN(UserRequest ureq) {
